...
public class RemoteShellKit {
    ...
    public static CmdResModel executor(String username,String password,String ip,int port,String command) throws IOException {
        //参数传服务器的地址
...
//这是接收错误信息
    ...
    public static CmdResModel executor1(String username,String password,String ip,String command) throws IOException {
        //参数传服务器的地址
